...
🧊 35% (48,000/200,000) [███░░░░░░░] In:45k Out:3k
...
```bash
echo '{"model":{"display_name":"MiniMax-M2.7"},"context_window":{"used_percentage":35,"context_window_size":200000,"current_usage":{"input_tokens":45000,"output_tokens":3000}},"cost":{"total_cost_usd":0.00,"total_duration_ms":3600000},"workspace":{"current_dir":"/test"}}' | python3 statusline.py
```
